        ...
        <div className={classes.aboutus__section}>
          ...
          <div className={classes.content}>
            <p style={{ fontFamily: 'DM Sans', fontSize: '17px' }}>
              ...
              Müşterilerimizin beklentilerini karşılamak ve hatta aşmak için her
              zaman en iyisini yapmaya kararlıyız. Firmamız, araçlarını teslim
              ettiğinizde size huzur ve memnuniyet garantisi sağlar. Çünkü biz,
              her işimizi titizlikle ve özenle gerçekleştirir, araçlarınızı ilk
              günkü gibi parlak ve kusursuz bir şekilde size teslim ederiz.
              Sizin için güvenilir bir iş ortağı olmak, bizim için bir
              ayrıcalıktır ve bu sorumluluğun bilinciyle hareket ediyoruz.
            </p>
          </div>
